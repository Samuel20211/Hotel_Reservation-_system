...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Email-Id:&nbsp;</strong>rockbeachhotel@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>+254713684565</p><br><br><br>
     <center><img src="devlop/admin.png"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
