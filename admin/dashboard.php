...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="dashboard.php?option=feedback">View Customer Feedback</a></li>
      ...
      <li><a href="dashboard.php?option=user_registration">Registered Users</a></li>
			<li><a href="dashboard.php?option=slider">Homepage Slider</a></li>
