...
<footer style="background-color: cyan;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo1.JPG"width="200px"height="50px"/><br><br>
    <p class="text-justify">Located in Ruiru Kiambu, Rock Beach Hotel offers accommodation with treatment rooms, steam and sauna. It also comes with a 25 metre long swimming pool. </p><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Ruiru P.O Box 2161</p>
      <p style="color:white;"><strong>Email:&nbsp;</strong>rockbeachhotel@gmail.com</p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>+254713684565</p><br><br><br>
     <center><img src="image/devlop/admin.png"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Rock Beach Hotel| 2021 All rights reserved </p>
</footer>
